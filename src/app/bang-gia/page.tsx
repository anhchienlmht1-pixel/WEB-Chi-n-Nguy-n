  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold text-neutral-50">Bảng giá cổ phiếu</h1>
        <div className="flex items-center gap-1 rounded-full border border-neutral-800 bg-neutral-900/60 p-1 shadow-lg shadow-black/20">
          {FILTERS.map((f) => (
            <button
              key={f.value}
              ...
              className={clsx(
                ...
                filter === f.value ? "bg-brand-600 text-white" : "text-neutral-400 hover:bg-neutral-800"
              )}
            >
              {f.label}
            </button>
