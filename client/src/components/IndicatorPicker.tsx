      ...
      >
        ...
        <div className="border-b border-slate-200 px-5 py-3 dark:border-slate-800">
          <input
            ...
            className="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-900 outline-none focus:border-slate-1000 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
        </div>
            ...
            return (
              <button
                ...
                className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm transition-colors ${
                  active
                    ? "bg-slate-100 text-slate-700 dark:bg-slate-1000/10 dark:text-slate-400"
