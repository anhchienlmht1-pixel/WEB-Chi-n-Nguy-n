  ...
  return (
    <section>
      <div className="mb-10 text-center">
        ...
        <h3 className="mt-2 text-2xl font-bold text-slate-900 dark:text-slate-100">Tín hiệu thực tế, kết quả thực tế</h3>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
          {top.map((t) => (
            ...
            >
              ...
              <div className="mt-4 space-y-1 border-t border-slate-100 pt-4 text-xs text-slate-500 dark:border-slate-800 dark:text-slate-400">
